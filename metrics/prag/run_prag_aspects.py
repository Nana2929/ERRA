...
dataset = "yelp"
fold = 1
prag_filepath = f"/home/P76114511/projects/aspect_retriever/prag_checkpoints/{dataset}/{fold}/{dataset}_generated.jsonl"
reviews_path = f"/home/P76114511/projects/nete_format_data/{dataset}/reviews.pickle"
aspect_path = (
    f"/home/P76114511/projects/nete_format_data/{dataset}/aspect_category_index.csv"
)
